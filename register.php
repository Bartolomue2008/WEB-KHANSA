...
<body class="bg-green-50 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-96 border-t-4 border-green-400">
        ...
        <form action="Proses_registrasi.php" method="POST" class="space-y-4">
            ...
            <button type="submit" name="register" class="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-2 rounded-md transition duration-200">Daftar</button>
        </form>
        <p class="text-sm text-center text-gray-600 mt-4">Sudah punya akun? <a href="Login.php" class="text-green-600 hover:underline">Login di sini</a></p>
    </div>
</body>
</html>